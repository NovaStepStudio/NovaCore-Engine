...
public class Main {
    ...
    public static void main(String[] args) throws Exception {
        ...
        log.info("Core", "novacore-engine v" + engineVersion + " starting");
        ...
        Runnable shutdownCallback = () -> {
            ...
            try { downloadManager.shutdown(); } catch (Exception ignored) { }
            try { broadcaster.stop(1000); } catch (Exception ignored) { }
        ...
        log.info("Core", "Version > " + engineVersion);
        log.info("Core", "Ready");
