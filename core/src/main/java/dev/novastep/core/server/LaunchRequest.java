...
public class LaunchRequest {
    ...
    public static class LaunchFeatures {
        ...
        public boolean hasQuickPlay() { return quickPlay != null && quickPlay.mode != null; }
    ...
    public String validate() {
        if (version == null || version.isBlank())           return "'version' es requerido";
        if (instancePath == null || instancePath.isBlank()) return "'instancePath' es requerido";
        if (isAuthlibEnabled()) {
