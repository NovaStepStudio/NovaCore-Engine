...
public class GameLogManager {
    ...
    public static class ParsedLogLine {
        ...
        public final String level;    // INFO, WARN, ERROR, FATAL, DEBUG
    ...
    public synchronized void writePreLaunchInfo(
        ...
        if (effectiveInfo != null) {
            ...
            writer.println("  Inherits    : " + (effectiveInfo.inheritsFrom != null ? effectiveInfo.inheritsFrom : "none"));
    ...
    private static final class NullGameLogManager extends GameLogManager {
        ...
        @Override public synchronized void log(String stream, String line) {}
        @Override public synchronized void close() {}
        @Override public synchronized void writePreLaunchInfo(
